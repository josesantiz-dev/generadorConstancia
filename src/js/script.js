...
var defaultCertPNG = "../images/certificates/dummy.jpeg";
...
function addField(text = "Nombre del campo", position = [20, 20], editable = true) {
  var data = `
 <div>
...
downloadZipButton.addEventListener("click", function (e) {
  ...
  var zipFilename = "CONSTANCIAS_tip.zip";
  var effectiveDOMs = [];
  var dataIndex = [];
    ...
    JSZipUtils.getBinaryContent(src, function (err, data) {
      ...
      if (count == sheetData.length) {
        zip.generateAsync({ type: "blob" }).then(function (content) {
          ...
          console.log("Tiempo tomado: " + timeDiff + "ms");
          progress.innerHTML = `Generando ${totalRows} constancias en ${timeDiff/1000} segundos`;
